...
# All elements get multiplied by 10
vector1 * 10

# Change everything to capital letters from lowercase
toupper(vector2) 

# Making the opposite. So TRUE becomes False and vice verse
!vector3
...
```{r Matrix Operations}
matrix1
matrix1[4, 1] #Retrieve nummber in column 4, row 1

matrix1[4,  ] #Gives entire roq

matrix1[ , 3] #Gives entire column

matrix1[c(12, 14)] #

matrix1[c(12:14)] #

matrix1[2:4, 1:3] # Retrieving rows 2-4, and columns 1-3
