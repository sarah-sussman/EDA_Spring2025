...
# Generate time series (trend test needs ts, not data.frame) # a second way to do this
...
> Answer: The negative slope indicates that there is a decreased trend in the average wind speed over time. We saw this with the decomposition and were able to conclude this with the season mann-kendall test.
