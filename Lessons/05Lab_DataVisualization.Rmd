...
#Read in data
PeterPaul.chem.nutrients <- read.csv(("./Data/Processed_KEY/NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv"),
  stringsAsFactors = TRUE)

EPAair <- read.csv(("./Data/Processed_KEY/EPAair_O3_PM25_NC1819_Processed.csv"), 
  stringsAsFactors = TRUE)
...
#Tidy up the code. split up so it fits on the pdf
PeterPaul.chem.nutrients %>%
  ggplot() +
...
#Apply a theme
surface_temp_1999_plot + 
  theme_gray() #default theme, looks the same as the previous plot

#Apply a ggtheme
surface_temp_1999_plot + 
  theme_wsj() + 
  scale_color_wsj() #wall street journal theme
